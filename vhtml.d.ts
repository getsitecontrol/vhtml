declare namespace vhtml {
	...
	type AnyComponent<PropsType> = FunctionalComponent<PropsType> | typeof Component;
	...
	function h<PropsType>(node:ComponentConstructor<PropsType> | FunctionalComponent<PropsType>, params:PropsType, ...children:(JSX.Element|JSX.Element[]|string)[]):JSX.Element;
